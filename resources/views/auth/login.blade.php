@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Quick Eats')])
      ...
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center" style="background:#fff;">
            ...
            <h4 class="card-title" style="color: black;font-weight: bolder;"><strong>{{ __('Login') }}</strong></h4>
          </div>
      ...
      <div class="row">
        <div class="col-6">
          @if (Route::has('password.request'))
            <a href="{{ route('password.request') }}" class="" style="color:#fff;font-weight: bolder;">
              {{ __('Forgot password?') }}
            </a>
          @endif
        </div>
        <div class="col-6 text-right">
          <a href="{{ url('register') }}" style="color:#fff;font-weight: bolder;">
