...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('menu-items-category.store') }}" enctype="multipart/form-data" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')

            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Add Menu Item Category') }}</h4>
                ...
                <div class="row">
                    ...
                    <div class="bmd-form-group{{ $errors->has('item_name') ? ' has-danger' : '' }}">
                      <div class="input-group">
                        ...
                        <input id="item_category_name" type="text" name="item_category_name" class="form-control"
                               placeholder="{{ __('Category Name...') }}" value="{{ old('item_category_name') }}" required>
                      </div>
                  ...
                  <span class="input-group-text">
                      <i class="material-icons">assignment</i>
                        ...
                        <textarea name="item_category_description" placeholder="Menu Item Description" class="form-control" rows="2">{{old('item_category_description')}}</textarea>
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-success">{{ __('Save Category') }}</button>
              </div>
            </div>
          </form>
        </div>
