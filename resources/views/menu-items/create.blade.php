...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('menu-items.store') }}" enctype="multipart/form-data" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
                ...
                <div class="row">
                    ...
                    <div class="bmd-form-group{{ $errors->has('item_name') ? ' has-danger' : '' }}">
                      <div class="input-group">
                        ...
                        <input type="text" name="item_name" class="form-control"
                               placeholder="{{ __('Item Name...') }}" value="{{ old('item_name') }}" required>
                      </div>
                  ...
                  <span class="input-group-text">
                      <i class="material-icons">assignment</i>
                        ...
                        <textarea name="item_description" placeholder="Item Description" class="form-control" rows="2">{{old('item_description')}}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="bmd-form-group{{ $errors->has('item_price') ? ' has-danger' : '' }} mt-3">
                      <div class="input-group">
                        ...
                        <input type="number" step="0.01" name="item_price" class="form-control"
                               placeholder="{{ __('Item Price...') }}" value="{{ old('item_price') }}" required>
                      </div>
                  ...
                  <span class="input-group-text">
                      <i class="material-icons">assignment</i>
                        ...
                        <textarea id="notes" name="notes" placeholder="Item Notes" class="form-control" rows="2">{{old('notes')}}</textarea>
                ...
                <div class="col-md-6">
                  ...
                  <div style="margin-left: 2em;" class="form-check form-check-radio form-check-inline">
                    <label class="form-check-label">
                      <input class="form-check-input" type="radio" name="is_vegan" id="inlineRadio1" value="0"> No
                      <span class="circle">
        <span class="check"></span>
                  ...
                  <div class="form-check form-check-radio form-check-inline">
                    <label class="form-check-label">
                      <input class="form-check-input" type="radio" name="is_vegan" id="inlineRadio2" value="1"> Yes
                      <span class="circle">
        <span class="check"></span>
    </span>
                    </label>
                  ...
                  <div class="col-md-6">
                    ...
                    <div style="margin-left: 2em;" class="form-check form-check-radio form-check-inline">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="is_halaal" id="inlineRadio11" value="0"> No
                        <span class="circle">
        <span class="check"></span>
    </span>
                      </label>
                    ...
                    <div class="form-check form-check-radio form-check-inline">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="is_halaal" id="inlineRadio12" value="1"> Yes
                        <span class="circle">
        <span class="check"></span>
    </span>
                      </label>
